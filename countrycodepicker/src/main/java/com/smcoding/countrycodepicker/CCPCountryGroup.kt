...
class CCPCountryGroup private constructor(
    ...
    @JvmField var areaCodeLength: Int,
    ...
    companion object {
        ...
        private fun initializeGroups() {
            countryGroups = SparseArray<CCPCountryGroup?>()
        ...
        private fun addGroupForPhoneCode1() {
            ...
            nameCodeToAreaCodes.put(
                "ca",
                "204/226/236/249/250/289/306/343/365/403/416/418/431/437/438/450/506/514/519/579/581/587/600/601/604/613/639/647/705/709/769/778/780/782/807/819/825/867/873/902/905/"
            ) //CANADA_AREA_CODES
         ...
         * +7 group
         */
        private fun addGroupForPhoneCode7() {
            val nameCodeToAreaCodes = HashMap<String?, String?>()
            nameCodeToAreaCodes.put("kz", "6/7") //Kazakhstan
            countryGroups!!.put(7, CCPCountryGroup("ru", 1, nameCodeToAreaCodes)) // RU
        }
